...
export const REHAB_SUGGESTIONS: Record<string, string[]> = {
  gross_motor: [
    ...
    '双脚跨越平衡软墩跑：沿直线摆放20cm高充气软墩，指导孩子双手侧平举，保持足跟交替跨越不偏斜，每日3组，每组10次。'
  ],
  sensory_processing: [
  ...
  attention: [
    '高灵敏感应反馈屏障训练：配套脑电智能反馈带，在无杂音室内对战电脑拼图，监测波值并动态降低难度以增强孩子面对挫折的自信。',
  ...
  learning_ability: [
    ...
    '建立家庭温暖正面强化的情绪同向：避免对孩子使用“笨、不行、哭什么哭”等粗暴负向言词，改用描述性肯定语鼓励其每一微小进步。'
  ]
};
