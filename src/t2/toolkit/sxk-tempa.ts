 ...
 * 來源檔：`07_气质/森心康1-3岁气质量表_SXK-TEMPa.html`（sha256 cdca9a13589f…）。
 * 分段只抄報告那一套（＝紙本「分數解讀」），`postMessage` 與中控台的兩套一個數字都沒有。
 */

import type { ToolkitBank } from './types';

export const SXK_TEMPA: ToolkitBank = {
  id: 'sxk-tempa',
  code: 'SXK-TEMPa',
  title: '森心康 1–3 岁气质量表',
  source: { file: '07_气质/森心康1-3岁气质量表_SXK-TEMPa.html', sha256: 'cdca9a13589f0c319126abc5599b29ccabce8d15b27b10ffd3fc6e96a9e45501' },
  options: [
    { value: 5, label: '非常符合' },
    { value: 4, label: '符合' },
    { value: 3, label: '有点符合' },
  ...
  sections: [
    {
      ...
      items: [
        ...
        { no: 3, text: '看图画书时坐不住', startMonth: null },
    ...
    },
    {
      ...
      items: [
        ...
        { no: 6, text: '换保育员或新玩伴会不安', startMonth: null },
        { no: 7, text: '被要求跟不熟的人打招呼会抗拒', startMonth: null },
    ...
    },
    {
      ...
      items: [
        ...
        { no: 8, text: '换新的托育或活动场所时适应特别慢', startMonth: null },
      ],
    },
    {
      key: 'D5',
    ...
    },
    {
      ...
      items: [
        ...
        { no: 4, text: '遇到新情况先表现出不情愿', startMonth: null },
        { no: 5, text: '被拒绝或被制止时反应特别负面', startMonth: null },
    ...
    },
    {
      ...
      items: [
        ...
        { no: 4, text: '堆积木或套圈圈会玩到完成为止', startMonth: null },
    ...
    },
    {
      ...
      items: [
        ...
        { no: 5, text: '吃饭或穿衣时需要人在旁边才专心', startMonth: null },
